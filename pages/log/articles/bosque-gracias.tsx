    ...
    <div className="w-full min-h-screen bg-primary-dark text-fourth-green pt-20">
      ...
      <div className="flex flex-col mx-auto items-start w-11/12 md:w-1/2">
        ...
        <p className="mb-2 text-justify mr-2">
          ...
          lo que nos provee el bosque y experimentar.<br></br>
          <br></br>
          ...
          Gracias para co-crear juntos durante toda la semana. <br></br>
          <br></br>
          ...
          tintas vegetales con frutos recolectados del bosque. <br></br>
          <br></br>
        ...
        <p className="mb-2 text-justify mr-2">
          <strong>DIA 5</strong>
          <br></br>
          <br></br>A este punto de la residencia, el nivel de compromiso de los
          ...
          <br></br>
          <br></br>
          Por la tarde noche, realizamos una lectura que trajo{" "}
          <a
            target="_blank"
            className=" underline font-semibold"
          ...
          para poder debatir aspectos de nuestra práctica; en esta ocasión sobre
          la jerarquía de valores que proponen los espacios de circulación de
          los archivos multimedia, sobre todo en redes sociales, y la
          (in)materialidad del arte digital en internet. <br></br>
          <br></br>
        ...
        <p className="mb-2 text-justify mr-2">
          <strong>DIA 6</strong>
          <br></br>
          <br></br>Fue realmente un privilegio poder pasar estos días en Bosque
        ...
        <p className="mb-2 text-justify mr-2">
          <strong>DIA 7</strong>
          <br></br>
          <br></br>Coordinamos junto a Santiago Ruau una visita al lago para
        ...
        <p className="mb-2 text-justify mr-2">
          ...
          <br></br>
          <br></br>La última noche fue una celebración inolvidable, que incluyó
        ...
        <ShareButtons
          url="https://newtro.xyz/log/articles/bosque-gracias"
          title="Bosquegracias x Newtro - Bitácora de la residencia"
        />
