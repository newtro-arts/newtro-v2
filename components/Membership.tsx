  ...
  return (
    <div className="w-full h-fit text-primary-dark bg-fourth-green rounded-tl-[15px] rounded-br-[15px] py-4 lg:py-0 pl-8 lg:mb-8 flex justify-between">
      <div className="flex flex-col lg:w-1/2 justify-center pr-4 lg:pr-0">
        <h4 className="font-semibold pragmatica-text text-3xl mb-4">
          Subscribe to our membership!
        </h4>
        <p className="mb-4 lg:mr-32">
          Join us to receive monthly art airdrops, and other special items we
          have reserved only for you.
        </p>
        <div className="flex">
          <Link
            href="https://hypersub.withfabric.xyz/"
      ...
      <Image
        ...
        width={800}
        height={100}
        className="hidden lg:block aspect-[16/6] object-cover rounded-br-[15px]"
      />
    </div>
  );
};
