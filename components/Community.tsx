      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="flex">
          ...
          <h5 className="text-xl lg:text-2xl py-6 pragmatica-text uppercase">Community</h5>
            ...
            <br></br><br></br>
            It is a space where, beyond building a common language among on-chain artists, we allow ourselves to openly collaborate, exchange information and experiences, thus boosting an impact that extends from the digital realm to the real world.</p>
